...
class JadwalMRTFragment : Fragment(), JadwalAdapter.OnItemClickListener {
    ...
    companion object {
        ...
        fun newInstance(asal: String, tujuan: String): JadwalMRTFragment {
            val fragment = JadwalMRTFragment()
            val args = Bundle()
