...
class AllPromoAdapter (private val promoItems: List<PromoItem>) :
    RecyclerView.Adapter<AllPromoAdapter.PromoViewHolder>() {
    ...
    inner class PromoViewHolder(private val binding: ItemPromoBinding) :
        ...
        fun bind(item: PromoItem) {
            ...
            binding.textPromoDescription.setTextColor(
